// Phase 15 Multi-Agent Debate Dispatch
...
export async function runMultiAgentDebate(ctx, opts) {
  ...
  // Phase 2: Technical + Sector parallel
  ...
  // Phase 3: Judge — at least 3/4 successful
...
/** Parse signal from Judge output */
