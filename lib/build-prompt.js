...
import { buildTemplatePrompt, DEFAULT_TEMPLATE, buildToolInstructions, buildIndicatorTable, buildValidationWarningText, buildSectorAlphaBlock, buildLstmSignalBlock, buildReversalSignalBlock, buildKronosSignalBlock, buildNormalizedReturnBlock } from './prompt-templates.js';
...
// resonance 函数动态导入，避免 service worker 加载 Node 原生模块 (better-sqlite3)
 ...
 */
export async function buildPromptByTemplate({ templateKey = DEFAULT_TEMPLATE, name, code, market, klines, period = 'monthly', provider = 'anthropic', extraContext, decisionMode = false, indexData = null, resonance = null, sectorAlphaData = null, lstmSignalData = null, kronosSignalData = null, reversalSignalData = null }) {
