...
import { buildTemplatePrompt, DEFAULT_TEMPLATE, buildToolInstructions, buildIndicatorTable, buildValidationWarningText, buildSectorAlphaBlock, buildLstmSignalBlock } from './prompt-templates.js';
...
import { getResonanceAsOf, formatResonanceSummary, buildResonanceConstraint } from './multi-period/resonance.js';
 ...
 */
export function buildPromptByTemplate({ templateKey = DEFAULT_TEMPLATE, name, code, market, klines, period = 'monthly', provider = 'anthropic', extraContext, decisionMode = false, indexData = null, resonance = null, sectorAlphaData = null, lstmSignalData = null }) {
