...
/**
 * @param {object} current - Structured data from current analysis
 * @param {object|null} parent - Structured data from parent period (e.g., daily→weekly, weekly→monthly), skip if null
