// Prompt version v1 baseline — original prompt templates used in initial evaluation
// See lib/prompt-templates.js for current versions
// This file is kept for reproducibility of historical eval runs
...
// Position percentile computation requirement (shared by technical/trend/sentiment templates)
...
// Available tools description (appended to prompt only when Anthropic provider enables tool_use)
...
// Template label mapping (used by popup)
...
/**
 * Get template prompt task text. periodLabel/unitLabel are already interpolated via template strings.
