 ...
 * @param {string} cutoffDate — eval scenario cutoff date
...
/** Calculate resonance directly from known directions (for batch/cache scenarios) */
export function calcResonanceFromDirections(monthly, weekly, daily) {
  ...
  const periodLabels = { monthly: 'Monthly', weekly: 'Weekly', daily: 'Daily' };
...
/** Generate HARD_CONSTRAINTS #11 guidance — inverse version */
